...
dài hơn còn đang sống có thể đang có điểm cao hơn cả \(B\) giả thuyết vừa kết
thúc.
...
bài tập~3 phần \enquote{Để tay vào} yêu cầu bạn dựng lại.

Đây là bảng duy nhất trong chương không đo bằng một script nằm trong tag, vì
bản \code{broken} cố ý không được commit. Mô hình thì vẫn là mô hình của tag
\code{ch05}, dựng bằng \code{train\_one(0, reverse\_source=True)}; hàm
\code{broken} chép đầy đủ trong research note của chương.
\end{measured}

Ở beam 2, luật sai cho 0.8400 trong khi giải mã tham lam cho 0.8533. Beam rộng
hơn mà lại kém beam bằng một, và chỗ mất nằm gọn ở câu \emph{ngắn}: 1.0000 tụt
...
xác suất chỉ có giảm, nên một giả thuyết còn sống mà đã thấp điểm hơn giả thuyết
hoàn tất tốt nhất thì không bao giờ vượt lên được nữa. Cắt nó đi là phép cắt
chính xác,
...
Lúc beam 2 còn kém tham lam, cách đọc đầu tiên của tôi là thiên lệch độ dài:
điểm của một giả thuyết là tổng các log xác suất, toàn số âm, nên câu càng dài
điểm càng thấp và beam search sẽ chuộng câu ngắn. Hiện tượng ấy có thật và có
tên, thiên lệch độ dài, nên nó dễ tin.
...
hóa theo độ dài, tức chia điểm cho số token trước khi so, và cả ba cột 0.8400,
0.9527 và 0.7303 đứng nguyên không đổi một chữ số nào; thứ duy nhất nhúc nhích
là độ dài trung bình, 13.827 thành 13.840. Chuẩn hóa độ dài là bản vá cho một
lỗi mà corpus này không có, và tôi đã suýt áp nó vì cái tên nghe đúng.

Còn một chuyện về beam search tôi cũng tin sai, theo chiều khác. Tôi ghi lại vì
đây là cái bẫy rất dễ sập vào. Beam rộng sinh ra tập ứng viên bao tập của beam hẹp, nên
...
Cái thứ hai lắp thêm lúc giải mã là ensemble: huấn luyện vài mô hình rồi cho
...
Bài cho cùng bậc độ lớn ở quy mô của nó. Một LSTM đảo với beam 12 được BLEU
