...
đầy đủ bằng \tn{lan truyền ngược qua thời gian}{backpropagation through time}.
...
thấy là một độ chính xác nhúc nhích khi đổi batch size. Repo có test riêng khóa
chuyện đó lại.
...
\begin{figure}[htbp]
  ...
  \caption{Encoder-decoder, vẽ theo hình 1 của bài. Encoder đọc câu nguồn đã
    ...
    phải đi lọt qua đó dù dài bao nhiêu. Chương~\ref{ch:mot-vector-cho-moi-tu}
    là chương nối thêm đường thứ hai qua \tn{chỗ thắt}{bottleneck} này.}
