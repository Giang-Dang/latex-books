...
\begin{bt}
  \item Phương trình~\eqref{eq:ch05-phan-ra} không có \(\vect{x}\) ở vế phải.
    ...
    khởi tạo, vế phải đổi thế nào và chỗ thắt dịch đi đâu?
  ...
  \item Mục~\ref{sec:ch05-giai-ma} nói beam rộng hơn không bảo đảm trả về giả
    thuyết có log xác suất cao hơn. Dựng một phản ví dụ nhỏ nhất bạn nghĩ ra
    được: một từ điển ba token, một cây xác suất bạn tự đặt, và hai bề rộng
...
\begin{bt}
  ...
  \item Mục~\ref{sec:ch05-giai-ma} kể một luật dừng sai làm beam 2 thua giải mã
  ...
  \item Corpus hiện sinh câu tối đa hai mệnh đề. Trong
...
\begin{bt}
  ...
  \item Đây là chỗ còn mở thật sự. \(\vect{v}\) là \(2 d_h\) số dấu phẩy động,
    nên về lý thuyết nó chứa được rất nhiều bit, thừa sức mã hoá mọi câu của
