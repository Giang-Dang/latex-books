...
cách từ đích tương ứng của nó bao xa. Bài viết: đảo câu nguồn để nguyên khoảng
cách \emph{trung bình} giữa các cặp từ tương ứng, \enquote{however, the first
...
Chữ \enquote{minimal time lag} ấy là chữ của chương~\ref{ch:lstm}. Nó là quãng
ngắn nhất mà tín hiệu lỗi phải đi được để mạng bắt đầu học được gì. Encoder đọc
xong dừng lại ở từ \emph{cuối} của câu nguồn, và decoder viết ra từ
\emph{đầu} của câu đích ngay sau đó. Không đảo thì hai từ ấy ứng với hai đầu
đối diện của câu, tức xa nhất có thể. Đảo thì chúng cạnh nhau.
...
luận rằng phép đảo cho \enquote{LSTMs with better memory utilization}.
...
huấn luyện nổi một mạng hồi quy thường trên bài toán không đảo, nhưng
\enquote{we believe that a standard RNN should be easily trainable when the
source sentences are reversed}, và nói thẳng ra là họ không kiểm bằng thí
