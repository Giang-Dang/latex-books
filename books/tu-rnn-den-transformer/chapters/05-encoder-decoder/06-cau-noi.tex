...
chương này, và phân biệt nó với bài thứ hai là việc mà cả chương này lẫn
chương~\ref{ch:dong-chinh} phải làm cho đúng.
...
Blunsom, \enquote{who were the first to map the input sentence into a vector and
then back to a sentence}. Chỗ khác nhau, cũng theo lời họ, là bài 2013 mã hoá
câu bằng mạng tích chập, và mạng tích chập thì \enquote{lose the ordering of the
words}.
...
Ngược lại, và ở bốn chỗ.

Tóm tắt, câu áp chót: \enquote{Additionally, the LSTM did not have difficulty on
long sentences.} Mục 3.7 của họ tên là \enquote{Performance on long sentences}
...
với chỗ nối khác và bề rộng khác. Và chính Sutskever ghi nhận điều đó trong mục
4 khi mô tả bài Bahdanau là dùng attention \enquote{to overcome the poor
performance on long sentences experienced by Cho et al.}.

Bốn chỗ, cùng một bài, cùng một hướng. Cái sai không nằm ở chỗ tin rằng chỗ thắt
