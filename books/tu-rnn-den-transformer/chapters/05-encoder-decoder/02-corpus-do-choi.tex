...
đồ họa, nên tôi không đi theo đường đó được, và nói rõ ngay từ đầu rằng cái tôi
dựng là đồ chơi.
...
thứ tiếng phải khác thứ tự từ đủ nhiều, vì
chương~\ref{ch:mot-vector-cho-moi-tu} cần một
...
\subsection*{Thứ duy nhất nó mô hình hóa thật}
...
không giải được corpus này, nên một mô hình học được phép
\tn{đồng chỉnh}{alignment} của nó thì đã học được cái gì đó thật.

Văn phạm sinh câu một hoặc hai mệnh đề, mỗi mệnh đề là chủ ngữ, động từ, tân
ngữ, cộng một cụm chỉ nơi chốn tùy chọn. Mỗi động từ tiếng Anh đúng một token,
...
\subsection*{Thứ nó không mô hình hóa, và chương sẽ không giả vờ}
