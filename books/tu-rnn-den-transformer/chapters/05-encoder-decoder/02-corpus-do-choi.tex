...
ma trận đồng chỉnh có chỗ bắt chéo chứ không phải một đường chéo.
...
Một mô hình dịch bài này bằng cách chép vị trí sang vị trí sẽ sai tính từ ở mọi
cụm có tính từ. Đó chính là điểm: một đồng chỉnh đường chéo không giải được
corpus này, nên một đồng chỉnh giải được nó đã học được cái gì đó.
...
\tn{ngoài từ điển}{out-of-vocabulary}, thứ ăn mất một phần điểm Bilingual
Evaluation Understudy, viết tắt là BLEU, của bài báo và được bài nhắc tới ngay
trong tóm tắt, không thể xảy ra ở đây. Và câu
...
0.9200 và chạy 40 epoch cho 0.9425, so với 0.8533 ở 14. Tôi in số ở 14 vì mười
...
trong chương này, nhớ rằng nó còn cách chỗ mô hình đi được vài điểm.
