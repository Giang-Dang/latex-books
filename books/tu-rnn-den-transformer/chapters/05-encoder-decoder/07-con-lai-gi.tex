...
Cái bài này giải được, phát biểu cho gọn: một mạng nơ-ron duy nhất, huấn luyện
đầu cuối và không giả định gì về cấu trúc bài toán, vượt được một hệ dịch thống
...
thuần nơ-ron vượt một hệ đối chứng cụm từ với khoảng cách đáng kể, và vượt được
dù không xử lý nổi từ \tn{ngoài từ điển}{out-of-vocabulary}; nguyên văn là
\enquote{by a sizeable
margin, despite its inability to handle out-of-vocabulary words}.
...
là khi dùng để chấm điểm lại một nghìn \tn{giả thuyết}{hypothesis} của chính
hệ đối chứng, tức
...
Câu thứ nhất: \tn{chỗ thắt}{bottleneck} là có thật.
Mục~\ref{sec:ch05-bop-vector} đo được nó, và đo được cả hình dạng của nó, tức
câu ngắn \tn{bão hòa}{saturation} trước còn câu dài cần vector rộng hơn hẳn. Ở
\(d_h = 64\), câu
...
chương~\ref{ch:mot-vector-cho-moi-tu} sẽ đọc không phải là nới vector ra, vì
nới ra thì lại hỏng ở câu dài hơn nữa. Nó là bỏ hẳn cái ràng buộc bề rộng cố
định đi.
...
phải vứt \(T - 1\) cái kia, và đó là câu hỏi
chương~\ref{ch:mot-vector-cho-moi-tu} mở ra.
...
Chương~\ref{ch:mot-vector-cho-moi-tu} giải quyết hai thứ đầu và không đụng tới
thứ ba. Nó thêm một đường đi từ mọi bước của encoder tới mọi bước của decoder,
đo cái chỗ
thắt \emph{trước} khi vá nó, rồi cho thấy đường mới ấy làm gì với gradient. Cái
giá là attention lúc đó vẫn là một thứ lắp thêm vào một mạng hồi quy, nên thứ
ba trong danh sách trên còn nguyên vẹn suốt cả chương ấy. Trong lịch sử thật nó
còn nguyên thêm hai năm nữa.
