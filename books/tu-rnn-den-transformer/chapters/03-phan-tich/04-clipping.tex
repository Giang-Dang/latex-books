...
Với \(w\) và \(b\) lớn như vậy, \(\sigma(a_{50})\) bão hoà về đúng 1 trong
float64, nên chi phí bằng \((1 - 0.7)^2\). Mạng không rơi vào một cực tiểu tệ
hơn. Nó rời khỏi bài toán, tới một chỗ mà \tn{độ dốc}{gradient} bằng không và không có đường
quay lại.
...
repo companion gói lại đúng một dòng ấy:
