...
khỏi bão hòa, tôi chạy nó ở trường hợp tuyến tính, tức \(\sigma\) là ánh xạ đồng
nhất, đúng bối cảnh phần phụ lục của bài: khi đó tích
trong~\eqref{eq:ch03-tich-jacobian} thu về đúng lũy thừa ma trận
...
gradient rồi sẽ tắt. Cái không đúng là chặn đơn điệu \(\eta^{\,t-k}\)
...
không phải lũy thừa của một ma trận. Công thức Gelfand không nói gì về tích như
thế.
