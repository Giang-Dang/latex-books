...
Chương~\ref{ch:ky-hieu-va-bptt} dẫn ra lan truyền ngược qua thời gian, viết
tắt là BPTT, theo cách quen thuộc: đẩy ngược
từng bước một, cộng dồn vào các ma trận trọng số. Bài báo viết lại cùng công
...
là \(\mat{W}_{hh}\transpose \diag(\sigma'(\vect{a}_{i-1}))\), vì họ đẩy \tn{độ dốc}{gradient}
...
Ma trận chuẩn tắc là trường hợp dễ: với chúng, bán kính phổ và chuẩn phổ là cùng
...
bảy, tức lớn hơn số đo được chừng một triệu lần. Trạng thái lớn dần, tanh bão hoà, \(\sigma'\) sụt về gần không, và
...
Bão hoà tự chặn là một tin tốt và một tin xấu. Tin tốt: gradient nổ hiếm khi
nổ mãi. Tin xấu: cơ chế chặn nó cũng là cơ chế xoá trí nhớ, vì
