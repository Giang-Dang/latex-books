...
và vượt qua một điểm rẽ nhánh. Chỉ sự kiện thứ nhất là \tn{điều kiện đủ}{sufficient condition} để gradient
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/ch03-vach-mat-loi}
  \caption{Lát cắt mặt lỗi dọc theo \(b\) tại \(w = 5.0\). Hai nhánh gần như
    phẳng, nối nhau bằng một vách rộng chưa tới một phần nghìn của \(b\). Chuẩn
    gradient tại đỉnh vách lớn hơn ở vùng phẳng năm bậc độ lớn, nên một bước
...
\begin{measured}{chuẩn gradient tại vách so với vùng phẳng}
\begin{minted}[fontsize=\footnotesize]{text}
...
\(b\) trên mỗi đơn vị \(w\), và chuẩn gradient tại đỉnh tăng khoảng năm lần sau mỗi
0.2 của \(w\).
...
\tn{Giả thuyết}{hypothesis} của bài là chỗ này: khi gradient nổ thì
\tn{độ cong}{curvature} cũng
