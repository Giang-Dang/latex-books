...
gradient một epoch; giữ epoch cố định là so 8 bước với 125 bước.

Đo bằng \code{experiments/ch10\_cifar.py} tại tag \code{ch10}.
\end{measured}

Bảng dừng ở 16000 ảnh chứ không chạy hết 50000, và lý do là ngân sách chứ không
phải khoa học: cả repo companion có một hạn mức thời gian tổng, thêm hàng 50000
thì vượt, và quyết định của sách là không nâng hạn mức ấy thêm lần nữa. Tôi nói
ra vì nó đổi một câu ở bảng dưới, chỗ ghi \enquote{over 16,000} mà nếu chạy đủ
thì có lẽ ghi được một con số.
...
Bảng nói ngược. Khoảng cách rộng ra, 0.1202 lên 0.2148.
...
\textbf{Hơn mười sáu lần, và với MLP khớp tham số thì bảng không nói được hơn
thế.} Trong toàn bộ dải đã quét, không lượng dữ liệu nào đưa nó tới chỗ CNN đạt
được bằng 1000 ảnh. Bảng ghi \enquote{over 16,000} chứ không ngoại suy, vì
ngoại suy ra ngoài dải đã đo là đúng chuyện
chương~\ref{ch:tien-huan-luyen} đã dành một bài tập để nói. Nếu hàng 50000 còn
trong bảng thì ô ấy có lẽ là một con số; nó bị cắt vì ngân sách, và đó là chỗ
duy nhất trong chương mà việc cắt lấy đi một kết quả.

Cột cuối là cột trả lời phản bác. Cho MLP 23.71 lần tham số thì nó \emph{có}
đạt tới, ở 10,958 ảnh, tức 11.0 lần. Bội số nhỏ đi rõ rệt và \emph{không} biến
mất. Đó là tỷ giá mà mục~\ref{sec:ch10-attention-lam-duoc} nói tới, đo ở quy mô
này: hai ràng buộc, nướng sẵn vào tầng, đáng khoảng một bậc độ lớn về dữ liệu,
và không mua lại được bằng cách đổ thêm tham số vào.
...
trên 12.62\% số ảnh còn MLP khớp tham số đổi trên 27.20\%: chưa bằng một nửa.
Thiên kiến quy nạp mua được cái đó, và nó mua được thật.

Nhưng nhìn hàng cuối. Ở phép dịch 8, CNN vẫn đổi ý trên 62.62\% số ảnh, và
