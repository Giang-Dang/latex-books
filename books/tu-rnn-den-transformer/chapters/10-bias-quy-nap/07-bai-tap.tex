...
\begin{bt}
  ...
  \item Ở phép dịch 8, mục~\ref{sec:ch10-anh-that} đo CNN đổi nhãn trên 62.62\%
...
hai phút rưỡi cộng lại, và gần hết chỗ ấy là một mục: phép quét ở
mục~\ref{sec:ch10-anh-that} huấn luyện 27 mô hình. Ba mục còn lại không huấn
...
\begin{bt}
  \item \textbf{Đo cái mục~\ref{sec:ch10-con-lai-gi} nói là chưa ai đo.} Bảng
    ...
    trong bội số 11.0 lần, bao nhiêu thuộc về tính cục bộ và bao nhiêu thuộc về
...
\begin{bt}
  \item Mục~\ref{sec:ch10-anh-that} đo bội số 11.0 lần trên CIFAR-10 với một
