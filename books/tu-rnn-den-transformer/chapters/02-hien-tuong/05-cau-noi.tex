...
\section{Ai đã thấy hiện tượng này trước đây?}
...
đạo hàm của \tn{hàm kích hoạt}{activation function} và với
\tn{ma trận trọng số}{weight matrix} hồi quy ở mỗi bước lùi,
...
\tn{phụ thuộc dài hạn}{long-term dependencies}. Cần thay đổi kiến trúc hoặc
thuật toán huấn luyện. Lời
...
Cả hai bài báo đều xác định đúng nguyên nhân, nhưng không ai trong số họ sửa được
nó. Hochreiter biết gradient biến mất nhưng chưa có giải pháp. Bengio chứng
minh điều đó là tất yếu về mặt xác suất, nhưng cũng dừng ở phần phân tích. Phải
...
\emph{tự} xác định vanishing và exploding gradient, dựa trên bài báo của
