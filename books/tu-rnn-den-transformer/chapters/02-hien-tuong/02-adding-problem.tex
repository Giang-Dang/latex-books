...
Cho một chuỗi $T$ \tn{bước thời gian}{timestep}. Tại mỗi bước $t$, mạng nhận
hai số:
\begin{itemize}
...
$\mathcal{N}(0, 0.1)$, \tn{hàm mất mát}{loss function} MSE trên output cuối
cùng.
...
\textbf{\tn{bài toán cộng}{adding problem} không phải là bài kiểm tra tốt cho
vanishing gradient}.
