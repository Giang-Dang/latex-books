...
\begin{bt}
  \item \tn{Bài toán cộng}{adding problem} yêu cầu mạng nhớ \textbf{hai} giá
    trị trong toàn bộ
...
\begin{bt}
  ...
  \item Dùng \mintinline{python}{torch.nn.RNN} (PyTorch) cài đặt lại
    \tn{bài toán sao chép}{copy task} với $T_{\text{mem}} = 20$. Để PyTorch tự
    tính gradient.
