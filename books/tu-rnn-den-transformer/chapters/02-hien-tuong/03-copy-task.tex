...
\tn{Bài toán sao chép}{copy task} kiểm tra trí nhớ theo cách trực tiếp nhất:
mạng đọc một
chuỗi, im lặng qua một khoảng trễ, rồi viết lại chính xác chuỗi đó.

\begin{figure}[ht]
  \centering
  \input{figures/tikz/ch02-copy-task-schema}
...
Tổng chiều dài chuỗi: $2T_{\text{mem}} + 1$. Bài toán khó hơn
\tn{bài toán cộng}{adding problem}
...
\begin{figure}[ht]
  \centering
  \input{figures/tikz/ch02-gradient-decay-curve}
...
không học được \tn{phụ thuộc dài hạn}{long-term dependencies}: tín hiệu học từ
tương lai không đến được
quá khứ xa.
