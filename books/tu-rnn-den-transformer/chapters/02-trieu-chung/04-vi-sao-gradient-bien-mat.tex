...
lần khi đi từ $t = 21$ về $t = 1$ trong bài toán sao chép $T_{\text{mem}} =
...
\begin{figure}[ht]
  \centering
  \input{figures/tikz/ch02-rnn-unrolled-gradient}
...
state bão hòa (tiến gần đến $\pm 1$), đạo hàm của nó tiến gần đến 0, và
...
Kết quả từ bài toán cộng cho thấy vanishing gradient không phải là định mệnh:
...
thông qua trị riêng lớn nhất của $\mat{W}_{hh}$ và điều kiện đủ của Pascanu
và cộng sự.
