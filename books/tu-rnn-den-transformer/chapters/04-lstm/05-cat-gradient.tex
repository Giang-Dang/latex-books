...
\(\vect{h}_{t-1}\) về quá khứ. Bài nói rõ phần còn lại được giữ, rằng lỗi tới
net input của \tn{ô nhớ}{memory cell} và của cổng \enquote{do not get
propagated back further in time (although they \emph{do} serve to change the
incoming weights)}~\autocite{hochreiter1997lstm}.
...
\enquote{không hại} hoá ra không phải một sự nhân nhượng, và
