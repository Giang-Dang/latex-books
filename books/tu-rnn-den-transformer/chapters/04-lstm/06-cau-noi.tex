...
\(g_{\mathrm{out}}\) bão hòa, đạo hàm của nó về không, và ô nhớ chết theo cách
mà chính CEC gây ra.
...
Cái được là ô nhớ tự học lúc nào nên xóa chính nó. Cái mất thì đọc thẳng ra từ
...
kết nối từ output của các ô nhớ, không từ trạng thái. Mà
output là
