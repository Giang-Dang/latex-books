...
\begin{bt}
  \item Trong companion repo, đổi hàm kích hoạt từ $\tanh$ sang
    ...
    không? Nếu không, vì sao? Gợi ý: ReLU không khả vi tại 0, nhưng sai phân
    hữu hạn thì vẫn chạy.

  \item Thêm một bước thời gian thứ tư với $\vect{x}_4 = [0.2, -0.5]$ và
...
\begin{bt}
  \item Đo thời gian chạy của \mintinline{python}{backward()} và
    ...
    Từ đó giải thích vì sao mọi framework deep learning đều dùng lan truyền
    ngược thay vì sai phân hữu hạn, và vì sao sai phân hữu hạn vẫn là công cụ
