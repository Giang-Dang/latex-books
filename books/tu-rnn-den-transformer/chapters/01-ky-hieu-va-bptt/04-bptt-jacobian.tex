...
BPTT không phải là một thuật toán mới. Nó là lan truyền ngược thông thường,
...
Đây là một vector $d_y$-chiều. Mỗi bước thời gian đóng góp gradient riêng,
...
được tích luỹ qua toàn bộ chuỗi:
...
tử $(i,j) = u_i v_j$. Đây chính là dạng Jacobian của gradient theo ma trận
trọng số: mỗi cặp (đầu vào, tín hiệu lỗi) đóng góp một hạng tử vào tổng.
...
lần. Khi $T$ lớn, tích này hoặc co về không hoặc bùng nổ, tùy vào giá trị
riêng lớn nhất của $\mat{W}_{hh}$. Đó chính là vấn đề
...
\begin{enumerate}
  ...
  \item \textbf{Lùi từ $T$ về $1$}:
    \begin{itemize}
      ...
      \item Tích luỹ gradient tham số từ
