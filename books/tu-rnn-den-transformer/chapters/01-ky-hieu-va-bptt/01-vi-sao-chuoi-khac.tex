...
từ \tn{bước thời gian}{timestep} trước sang bước thời gian sau.
...
rồi \tn{lan truyền ngược}{backpropagation} như mạng nơ-ron thường. Vì trạng
thái ẩn tại bước $t$ phụ thuộc vào trạng thái ẩn tại bước $t-1$, gradient của
\tn{hàm mất mát}{loss function} phải
