...
cho toàn bộ chuỗi. Đây không phải là chỗ để đọc lướt; mỗi ký hiệu trong dẫn
...
Trạng thái ẩn ban đầu $\vect{h}_0 = \vect{0}$ (vector không). Đây là lựa chọn
...
token. Nhưng những hàm mất mát đó thêm một tầng softmax và một tầng Jacobian
