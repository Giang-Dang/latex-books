...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/ch08-the-cut}
  ...
  which is section~\ref{sec:ch08-what-is-left-behind}. The dashed boundary is
...
Nine files changed path and one of them changed content:

\begin{minted}[fontsize=\footnotesize]{text}
R  src/Mosaic.Api/Catalog/CatalogRegistration.cs   -> src/Mosaic.Catalog/Catalog/CatalogRegistration.cs
R  src/Mosaic.Api/Catalog/Data/CatalogDataLoaders.cs -> src/Mosaic.Catalog/Catalog/Data/CatalogDataLoaders.cs
R  src/Mosaic.Api/Catalog/Data/CatalogSeedData.cs  -> src/Mosaic.Catalog/Catalog/Data/CatalogSeedData.cs
R  src/Mosaic.Api/Catalog/Data/CatalogService.cs   -> src/Mosaic.Catalog/Catalog/Data/CatalogService.cs
R  src/Mosaic.Api/Catalog/Data/ProductConfiguration.cs -> src/Mosaic.Catalog/Catalog/Data/ProductConfiguration.cs
R  src/Mosaic.Api/Catalog/Model/Product.cs         -> src/Mosaic.Catalog/Catalog/Model/Product.cs
R  src/Mosaic.Api/Catalog/Model/ProductCategory.cs -> src/Mosaic.Catalog/Catalog/Model/ProductCategory.cs
R  src/Mosaic.Api/Catalog/Types/CatalogQueries.cs  -> src/Mosaic.Catalog/Catalog/Types/CatalogQueries.cs
R  src/Mosaic.Api/Catalog/Types/ProductNode.cs     -> src/Mosaic.Catalog/Catalog/Types/ProductNode.cs
\end{minted}

\code{CatalogQueries} did not change at all. The four root fields
chapters~\ref{ch:hotchocolate-quickly} to~\ref{ch:schema-design-that-survives-change}
built, including the deprecation
chapter~\ref{ch:schema-design-that-survives-change} put on \code{products},
compiled in the new project untouched. So did the DataLoader, the seed data and
the entity configuration.

\code{CatalogService} changed in two ways and both are in its constructor:
...
gone along with the six calls to it. That counter was built in
