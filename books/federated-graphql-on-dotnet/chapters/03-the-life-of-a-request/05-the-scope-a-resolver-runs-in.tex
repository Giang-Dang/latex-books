...
Figure~\ref{fig:ch03-scopes} is the arrangement those numbers describe: which
provider each field is drawing from, and which one lives as long as the request.

\begin{figure}[htbp]
  \centering
  \input{figures/tikz/ch03-scopes}
