...
sells to people who have not signed in. A field that needs
a caller says so itself, and the router refuses that field to an anonymous
request whatever this setting is. The global switch decides whether an anonymous
request may enter the graph at all, not whether it may have everything in it.
