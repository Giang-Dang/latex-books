...
and asks it a question, which is the first answer about Mosaic that will have
crossed a boundary without me assembling it by hand. The sample router in
chapter~\ref{ch:how-a-federated-query-actually-runs} did it first, for two
subgraphs built to be watched. This is the storefront.
