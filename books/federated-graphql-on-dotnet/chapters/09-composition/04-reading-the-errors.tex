...
The rest of this section is four failures, all produced from Mosaic's real pair
...
minute of counting. The composer printed that error twice, identically. A
different case I ran while researching this chapter printed its error three
times. I have not established the pattern and I will not invent one, so take
only this away: the number of blocks in the table is not the number of things
wrong with your graph.
...
Three of the four failures in this section come out of a single error factory:
