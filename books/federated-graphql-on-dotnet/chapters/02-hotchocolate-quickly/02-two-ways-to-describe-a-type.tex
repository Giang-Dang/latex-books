...
Figure~\ref{fig:ch02-authoring-styles} is the shape of that: three roads into
one type system, and one document out of it.

\begin{figure}[htbp]
  \centering
  \input{figures/tikz/ch02-authoring-styles}
