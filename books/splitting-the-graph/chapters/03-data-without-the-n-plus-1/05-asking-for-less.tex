...
the resolver the client's selection set in a form \code{IQueryable} understands,
and \code{With} applies it:
...
The schema gains the Relay shape, named after the field. The exported file
