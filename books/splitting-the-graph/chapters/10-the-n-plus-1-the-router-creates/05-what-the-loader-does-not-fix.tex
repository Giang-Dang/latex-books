...
\index{projection!chapter 6 left it off and promised the reason}%
Chapter~\ref{ch:first-subgraph} left the projection off this route on purpose
and promised this chapter the reason. Here it is, in two halves: the
projection works, and it cannot be combined with the loader
section~\ref{sec:ch10-the-loader-behind-the-resolver} just added.
