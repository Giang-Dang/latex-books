...
out of a version~14 build of these same files. Chapter~\ref{ch:composition} is
where a second tool reads those weights and has an opinion about them, and
chapter~\ref{ch:operations} is where you choose your own.
