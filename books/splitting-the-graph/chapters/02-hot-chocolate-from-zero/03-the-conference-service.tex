...
/// <summary>
/// The conference program, held in memory. The next chapter replaces this
/// with SQLite and EF Core; nothing outside this file knows where the data
/// lives.
/// </summary>
...
\code{Speaker}. That is worth pausing on, because it is the same shape you will
