...
checks. Which service owns which type, which fields identify one object across
services, which is what chapter~\ref{ch:federation-model} will call a key, and
which subgraph may add fields to a type another one owns: these are negotiated
