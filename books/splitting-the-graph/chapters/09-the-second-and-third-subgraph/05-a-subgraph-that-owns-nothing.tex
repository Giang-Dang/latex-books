...
throws and nothing has been configured to tell you more. Here it means one
thing: a resolver asked the container for something and was handed a null.
Section~\ref{sec:ch09-what-sessions-keeps} got the same sentence out of a stub
advertising a key it cannot resolve, and the message never says which.
