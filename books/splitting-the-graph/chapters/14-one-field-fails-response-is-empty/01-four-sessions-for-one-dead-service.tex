...
\index{errors!five for one dead service}%
That page carries five errors, and
section~\ref{sec:ch14-how-far-a-null-climbs} needs the count: the fetch
failure, and then one for each of the four sessions, because
...
damage is what that chapter said it was.
...
declared both in the same file, neither as a reliability decision. One of them
is a client that renders the program with blank scores. The other is a client
