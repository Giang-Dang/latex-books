...
are the same thing, and nothing in the response tells it. The type name is
available, through \code{\_\_typename}, so a careful client can pair the two and
be safe. That is the point: the schema has pushed a decision onto every client
...
a different field. Change it and every stored query breaks. Add a second field
