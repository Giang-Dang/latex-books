...
sent with \code{\{"id": "U3BlYWtlcjox"\}} as its variables, which is speaker~1:
...
Tooling is where the change lands. Introspect the \code{Query} type and
\code{sessionById} is not in the list; ask again with
