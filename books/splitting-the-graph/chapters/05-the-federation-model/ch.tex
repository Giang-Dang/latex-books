...
\input{chapters/05-the-federation-model/01-the-join-you-cannot-see}
\input{chapters/05-the-federation-model/02-one-endpoint-many-owners}
\input{chapters/05-the-federation-model/03-which-federation-and-why}
\input{chapters/05-the-federation-model/04-an-entity-is-a-type-with-a-key}
\input{chapters/05-the-federation-model/05-who-owns-a-field}
\input{chapters/05-the-federation-model/06-the-directives}
\input{chapters/05-the-federation-model/07-the-graph-this-book-builds}
\input{chapters/05-the-federation-model/08-summary}
