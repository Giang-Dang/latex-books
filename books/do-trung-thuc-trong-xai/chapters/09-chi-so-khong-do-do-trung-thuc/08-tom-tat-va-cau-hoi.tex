...
\begin{itemize}
  ...
  hiện được nếu một phép tính đã biết trước đã xảy ra, nên nhãn đúng đến từ
  thiết kế nhiệm vụ. Hình~\ref{fig:ch09-vong-kiem-dinh} cho thấy hệ quả về thứ
  ...
  nhiệm vụ, gán nhãn bằng một đường ống hai pha ưu tiên độ chính xác hơn độ
  phủ, đạt độ chính xác 98.9\% khi đối chiếu với sáu người chú giải. Tỉ lệ
...
\begin{cauhoids}
  ...
  lý do các tác giả xếp nó là trần trên chứ không phải chỉ số dự thi, rồi cho
