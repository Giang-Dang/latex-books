...
ví dụ bài báo nêu là bản đồ chú ý và điểm nổi bật~\autocite{p21metrics}.
...
nay không thuộc lớp đó: chuỗi ấy là lời kể dài mà mô hình phát ra trong lúc
giải bài, và nó có thể chứa nhiều bước không nối trực tiếp với tiên đoán, thậm
chí không liên quan gì tới tiên đoán~\autocite{p21metrics}. Việc bài báo phải
...
\enquote{trung thực} khi chủ thể là một mô hình biết nói. Theo
...
câu khẳng định trần trụi nằm ngoài phạm vi, còn những
...
thể xuyên tạc cách mô hình suy luận, chẳng hạn khi mô hình đi theo một gợi ý
