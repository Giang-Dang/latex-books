...
lựa chọn: phần lớn các chỉ số cần truy cập vào bên trong mô hình, số còn lại
cần sửa được phần suy luận của nó, mà điều thứ nhất thì không làm được với mô
hình đóng~\autocite{p21metrics}.

Mỗi chuỗi được cắt thành các bước ở mức câu, rồi đi qua một đường ống nhiều
nhánh, mỗi nhánh phụ trách một loại bước. Mỗi nhánh chạy hai pha: một bộ giám
khảo yếu hơn truy hồi các bước ứng viên khớp định nghĩa của loại đó, rồi một
bộ giám khảo mạnh hơn xác nhận hoặc loại từng ứng viên. Các tác giả nói rõ
đường ống ưu tiên độ chính xác hơn độ phủ, vì các nhãn này đóng vai trò ground
...
Độ chính xác của đường ống được đo bằng người chứ không bằng lập luận. Sáu
người chú giải đánh giá 88 nhãn chia đều giữa trung thực và không trung thực,
và chỉ một bước bị đánh là sai, cho độ chính xác 98.9\% với khoảng tin cậy
95\% là từ 96.6\% tới 100\%. Mức đồng thuận giữa những người chú giải là
96.6\%, và hệ số AC1 của Gwet là 0.976; các tác giả dùng AC1 thay cho kappa vì
dưới phân bố nhãn lệch mạnh như ở đây kappa bị kéo tụt một cách nghịch lý dù
mức đồng thuận thô rất cao~\autocite{p21metrics}. Một phép rà thứ hai lấy 50
...
nhiệm vụ. Nó cho 1\,946 nhãn ở mức bước, chia 51\% trung thực và 49\% không
trung thực, cùng 1\,120 nhãn ở mức cả chuỗi, chia 15\% trung thực và 85\%
không trung thực~\autocite{p21metrics}.

Chênh lệch giữa hai tỉ lệ ấy không phải là một quan sát về các mô hình, và đọc
nhầm nó thành như vậy là cái bẫy đầu tiên của bảng số. Nó là hệ quả trực tiếp
...
Có bộ dữ liệu rồi thì phần còn lại là chấm điểm. Mục sau đọc kết quả.
