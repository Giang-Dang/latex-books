...
phụ lục~\ref{app:ky-hieu} ghi lại phép đối chiếu đó.

Chữ $g$ ở đây là mô hình dễ đọc, và nó không phải hàm attribution
$\mathcal{A}_{f,x}$ của định nghĩa~\ref{def:ch07-ham-attribution}: $g$ nhận một
đầu vào và trả một dự đoán, còn $\mathcal{A}_{f,x}$ nhận một đối tượng trong $E$
và trả một điểm số. Quan hệ giữa hai hàm là quan hệ giữa một mô hình và các hệ
số của nó, và nó chỉ viết ra được khi $\mathcal{G}$ đã được chọn. Với
$\mathcal{G}$ là lớp tuyến tính trên biểu diễn nhị phân $z'$ mà
chương~\ref{ch:lime} đã dựng, quan hệ ấy là
\[
  g(z') = \beta_0 + \sum_j \mathcal{A}_{f,x}(j)\, z'_j ,
\]
trong đó $\beta_0$ là hệ số tự do, tức các điểm số attribution đúng bằng các hệ
số còn lại của $g$. Ngoài lớp tuyến tính
thì không có công thức chung nào như vậy, và một $\mathcal{G}$ khác cho một cách
đọc điểm số khác.
...
tác động lên $x$ theo một trong ba cách mà bảng của bài liệt kê: nhân từng thành
phần để che bớt đầu vào, cộng vào để làm nhiễu nó, hoặc nhân cả vector với một
số vô hướng. Occlusion lấy
