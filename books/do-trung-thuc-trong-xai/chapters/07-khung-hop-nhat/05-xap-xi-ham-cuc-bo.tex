...
$\mathcal{G}$ là lớp tuyến tính trên biểu diễn nhị phân $z$, quan hệ ấy là
\[
  g(z) = \beta_0 + \sum_j \mathcal{A}_{f,x}(j)\, z_j ,
\]
tức các điểm số attribution đúng bằng các hệ số của $g$. Ngoài lớp tuyến tính
