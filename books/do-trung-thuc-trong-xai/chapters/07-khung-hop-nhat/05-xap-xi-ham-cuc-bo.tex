...
nào, và đo sai lệch bằng hàm mất mát nào~\autocite{p18unified}. Occlusion lấy
mẫu bằng vectơ one-hot ngẫu nhiên và đo bằng sai số bình phương; KernelSHAP
cũng đo bằng sai số bình phương nhưng lấy mẫu theo \tn{hàm nhân Shapley}{Shapley kernel};
LIME lấy mẫu theo một \tn{hàm nhân}{kernel} mũ; còn nhóm gradient thì đo bằng phép khớp
gradient chứ không phải sai số bình phương.
...
sự khác biệt giữa hai mô hình trong lân cận đã chọn, chứ không phạt một đại
lượng thay thế nào khác.
...
đối xứng. Attribution đặc trưng xấp xỉ \emph{dự đoán} của mô hình trên không
gian các đặc trưng. Theo phỏng đoán của các tác giả,
\tn{attribution dữ liệu}{data attribution} xấp xỉ \emph{trọng số} của mô hình
trên không gian các điểm huấn luyện, còn
\tn{attribution thành phần}{component attribution} lại xấp xỉ dự đoán, lần này
trên không gian các thành phần~\autocite{p18unified}. Các tác giả viết nó
ở dạng phỏng đoán và không chứng minh, nên \tn{hàm attribution}{attribution function}
của định nghĩa~\ref{def:ch07-ham-attribution} vẫn là mẫu số chung duy nhất mà cả
