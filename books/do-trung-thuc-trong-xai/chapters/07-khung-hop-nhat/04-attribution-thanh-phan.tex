...
lớp, một đầu chú ý, hoặc một mạch, tức một mạng con nối các bộ phận ấy lại thành
...
các thành phần, thường bằng cách làm hỏng đầu vào để sinh ra kích hoạt sai. Lượt
...
Chỗ hở của thủ tục nằm ở chữ \enquote{làm hỏng}. Bài báo liệt kê ít nhất năm cách: đặt
...
đúng như \tn{điểm nền}{baseline} trong chương~\ref{ch:attribution-theo-gradient}
...
này, với phép lấy mẫu và một thuật toán multi-armed bandit để khoanh nhanh những
nơ-ron điểm cao. Về phía gradient, attribution patching xấp xỉ thay đổi cục bộ
của một lần vá bằng hai lượt truyền xuôi và một lượt truyền ngược, thay vì chạy
lại mô hình cho từng thành phần; bản mở rộng cho mọi cạnh của đồ thị tính toán
chấm điểm tất cả
