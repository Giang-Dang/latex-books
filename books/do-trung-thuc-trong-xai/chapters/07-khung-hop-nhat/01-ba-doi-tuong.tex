...
attribution $\mathcal{A}_{f,x} : E \to \mathbb{R}$ gán cho mỗi phần tử
$e \in E$ một số thực, được diễn giải là mức đóng góp của $e$ vào đầu ra
$f(x)$.
\end{definition}

Chỉ số $f,x$ viết ra vì hàm attribution đổi khi đổi mô hình hoặc đổi điểm cần
giải thích; miền của nó là tập đối tượng $E$ chứ không phải không gian đầu vào,
và đó là chỗ nó khác với một mô hình thay thế.
