...
\tn{lời giải thích phản thực}{counterfactual explanation}~\autocite{p20trends}.
...
cục với cục bộ~\autocite{p20trends}. Đọc ba bảng ấy theo cách phân loại của
mục~\ref{sec:ch07-ba-doi-tuong}, cả ba nhánh attribution đều thuộc giai đoạn sau khi dựng mô hình, vì cả
...
Khác biệt nằm ở mức được giải thích. Lời giải thích thông thường nói vì sao
từng bước tính toán cho ra kết quả của nó; siêu suy luận nói vì sao hệ thống
chọn suy luận bao nhiêu và theo cách nào, và hệ thống được quan sát và điều
khiển ở mức trên ấy~\autocite{p20trends}. Hướng thứ hai thuộc về học tăng
cường, nơi một hệ tự hành chọn hành động và nhận phần thưởng từ môi trường;
mong muốn của khảo sát là lời giải thích của hệ bám vào phần thưởng ấy thay vì
phải mô tả toàn bộ không gian trạng thái mà hệ có thể gặp. Khảo sát gắn hướng
này với hai chủ đề của nhánh ấy,
\tn{hệ tự hành đáng tin cậy}{trustworthy autonomous systems} và
\tn{ngẫu nhiên hóa miền}{domain randomization}, và sách chỉ ghi lại tên chúng
để bản đồ đủ chứ không đi vào~\autocite{p20trends}. Hướng thứ ba là dùng chính
...
nhau~\autocite{p20trends}, và sách đọc điều đó là: chúng đang được đề xuất làm
công cụ giải thích trước khi có ai kiểm chứng chúng giải thích đúng.
