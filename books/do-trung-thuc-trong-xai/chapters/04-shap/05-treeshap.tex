...
Linear SHAP, Max SHAP và Deep SHAP~\autocite{p10shap}. Các công trình sau
...
\tn{giá trị Shapley}{Shapley value}. TreeSHAP tận dụng hai tính chất của cây:
một đường đi chỉ kiểm tra một số đặc trưng, và nhiều liên minh có chung tiền
tố.
