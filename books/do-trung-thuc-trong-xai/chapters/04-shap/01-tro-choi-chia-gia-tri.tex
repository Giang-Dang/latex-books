...
minh $S \subseteq \mathcal{P}$ tạo ra. Bài báo viết $F$ cho tập này, nhưng
phụ lục~\ref{app:ky-hieu} đã dành $F$ cho hàm điểm số đang được attribution
và $N$ cho số mẫu của LIME, nên trò chơi dùng chữ thứ ba.
