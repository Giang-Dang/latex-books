...
Thước đo mà mục trước để lại là chỗ khảo sát tự đề xuất lối ra, và đọc lối ra ấy
...
Đó không phải một nhận xét về từ vựng. Một khảo sát năm 2025 về toàn bộ các biến
...
không cần tới cái tên của quan hệ ấy. Đây là lần thứ hai một khảo sát của nhánh
phương pháp không giao với từ vựng của nhánh phê phán:
...
đúng là định nghĩa~\ref{def:ch01-do-trung-thuc}, dưới cái tên thứ ba.
...
rằng đã có sẵn một phổ rộng các thước đo phù hợp và đã được thiết lập tốt, chỉ
...
của sách chứ không phải của bài báo. Các thước đo được gọi ở đó là đã được thiết
...
giá dựng từ những thước đo ấy sẽ xếp hạng 48 biến thể bằng một bộ dụng cụ mà
không ai biết có đo đúng đại lượng ghi trên mặt đồng hồ hay không.

Ở đây phải dừng lại một nhịp để không lấy nhầm bằng chứng.
...
phải là các thước đo ấy đã bị chứng minh là hỏng, mà là chưa ai kiểm chứng chúng
