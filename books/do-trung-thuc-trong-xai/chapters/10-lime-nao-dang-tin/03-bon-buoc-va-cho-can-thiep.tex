...
ba là attribution đặc trưng: khớp một mô hình khả diễn giải, thường là tuyến
...
trên quy trình. Biểu diễn $x'$ thuộc bước một; phép dựng lại $z$, phân phối sinh
...
mẫu riêng cho từng kiểu dữ liệu. Ở bước ba có bốn nhóm: sửa mô hình tuyến tính,
...
một hệ lập trình logic quy nạp, thì cái còn lại của LIME chỉ là ý tưởng nhiễu
quanh một điểm rồi khớp một mô hình khả diễn giải. Bốn bước vì thế vừa là hệ tọa
