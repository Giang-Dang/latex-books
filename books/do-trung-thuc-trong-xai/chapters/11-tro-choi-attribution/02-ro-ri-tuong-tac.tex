...
Phép nối tầng của phương trình~\ref{eq:ch11-noi-tang} lấy $\varphi_1$ vừa tính
và coi nó như một hàm mới của cùng hai đặc trưng, rồi chạy lại giá trị Shapley
trên nó. Che đặc trưng thứ hai trong
$\varphi_1(\cdot,f) = x_1 + x_1x_2^2/2$ để lại $x_1$; che đặc trưng thứ nhất để
lại không. Nên bốn liên minh của trò chơi tầng hai có giá trị $0$, $x_1$, $0$ và
$x_1 + T/2$, và
\[
  \varphi_1\bigl(x,\ \varphi_1(\cdot,f)\bigr) = x_1 + \frac{T}{4},
  \qquad
  \varphi_2\bigl(x,\ \varphi_1(\cdot,f)\bigr) = \frac{T}{4} .
\]
...
Meta-SV, phương pháp mà mục~\ref{sec:ch11-tro-choi-dung-tren-attribution} đọc
kỹ, chia khác. Nó tách hiệu ứng riêng $x_1$ và $0$ ra khỏi tương tác, rồi
