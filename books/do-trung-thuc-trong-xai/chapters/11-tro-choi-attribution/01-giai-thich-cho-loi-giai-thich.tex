...
Bài báo và sách viết ký hiệu khác nhau ở hai chỗ, và cả hai chỗ đều đáng ghi
lại vì người đọc sẽ mở bài ra. Bài viết $\phi_i(f,x)$ với mô hình đứng trước,
còn sách giữ thứ tự
$\varphi_i(x,f)$ mà phụ lục~\ref{app:ky-hieu} đã chốt từ
chương~\ref{ch:attribution-tu-nguyen-ly-dau}. Và bài đặt cho vế trái của
phương trình~\ref{eq:ch11-noi-tang} một ký hiệu riêng, $\psi_{i,j}$, mà sách
không dùng: $\psi$ đã được chương~\ref{ch:khung-hop-nhat} gán cho attribution
của một điểm huấn luyện, và một cuốn sách giữ một tên cho một khái niệm thì
không lấy lại ký hiệu ấy cho một thứ khác. Viết đủ như phương
trình~\ref{eq:ch11-noi-tang} cũng nói rõ hơn cấu trúc mà mục này đang bàn.
