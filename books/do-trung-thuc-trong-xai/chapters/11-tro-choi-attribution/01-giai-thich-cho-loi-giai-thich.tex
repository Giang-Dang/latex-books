...
Bài đặt cho vế trái của phương trình~\ref{eq:ch11-noi-tang} một ký hiệu riêng,
$\psi_{i,j}$, mà sách không dùng: $\psi$ đã thuộc về attribution của một điểm
huấn luyện ở chương~\ref{ch:khung-hop-nhat}, và viết đủ như phương
trình~\ref{eq:ch11-noi-tang} cũng nói rõ hơn cấu trúc đang bàn. Bài cũng viết
$\phi_i(f,x)$ với mô hình đứng trước, còn sách giữ thứ tự $\varphi_i(x,f)$;
phụ lục~\ref{app:ky-hieu} ghi cả hai phép đối chiếu.
