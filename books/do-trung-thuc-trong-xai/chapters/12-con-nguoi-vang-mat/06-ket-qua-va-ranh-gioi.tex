...
Hai cách đọc dấu vừa thuật lại là của bài báo, và chúng không khớp với thang mà
chính bài báo đặt ra. Mục~\ref{sec:ch12-mot-phep-doi-chieu} đã ghi thang ấy: 1
là câu trả lời tích cực nhất, nên điểm càng nhỏ càng tốt. Với quy ước đó, tương
quan âm giữa sparsity và điểm gộp nghĩa là sparsity càng cao thì điểm càng nhỏ,
tức người dùng càng hài lòng, ngược với câu \enquote{thích những lời giải thích
đổi ít đặc trưng}; cách đọc dấu dương ở Obesity Levels lệch theo đúng kiểu ấy.
Hai câu của bài chỉ đứng vững nếu điểm đã được đảo mã trước khi tính tương quan.
Bài không nói ở đâu rằng có bước đảo mã, và cũng không công bố mã nguồn hay dữ
liệu để kiểm. Sách vì vậy dừng ở chỗ ghi nhận: chiều sở thích của người dùng
trong hai bộ dữ liệu ấy là điều chưa xác định được từ những gì bài in ra, và
sách không chọn giúp một cách mã hóa để lấp chỗ trống.

Điều đáng nói là kết luận của mục này không phụ thuộc vào chỗ trống ấy. Việc các
hệ số \emph{đổi dấu} khi chuyển bộ dữ liệu là một quan sát về sự không nhất
quán, và nó giữ nguyên dù quy ước mã hóa có là chiều nào, miễn là cùng một quy
ước được dùng cho cả ba bộ.
...
mẫu này nên không có con số~\autocite{p25userperception}. Ở trường hợp mà bài
báo đem ra minh họa và gọi là tiêu biểu, dự báo chiều hài lòng trên Heart
Disease, rừng ngẫu nhiên đạt $R^2$
