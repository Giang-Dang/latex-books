...
bài~\autocite{p26limits}, và ý chứng minh lại là phép đếm cũ nhìn theo hình học.
Một hàm $g$ trong ngân sách $b$ chia $[0,1]^d$ thành không quá $2^{b+1}$ vùng
nhận giá trị khác nhau, nên theo nguyên lý ngăn kéo có ít nhất một vùng thể tích
không dưới $2^{-(b+1)}$, và một vùng thể tích ấy trong $\mathbb{R}^d$ có đường
kính không dưới cỡ $2^{-b/d}$ theo bất đẳng thức đẳng chu. Chọn $f$ biến thiên
với độ dốc đúng bằng $L$ dọc theo đường kính ấy thì $f$ đổi một lượng cỡ
$L \cdot 2^{-b/d}$ trong khi $g$ giữ một giá trị hằng, nên sai số không nhỏ hơn
một nửa lượng đó.

Bài phát biểu ngay sau đó rằng hai chặn khớp nhau tới hằng số, tức tồn tại
những hàm Lipschitz mà sự đánh đổi của chúng đạt đúng chặn trên của phép dựng
lưới~\autocite{p26limits}. Sách không nhận phát biểu ấy, và lý do đọc được bằng
cách viết cả hai chặn theo cùng một biến. Ở ngân sách $b$, phép dựng lưới đạt
sai số cỡ $L \cdot b^{-1/d}$, vì $b$ bit mua được cỡ $b$ ô lưới sau khi đã trả
tiền mã hóa giá trị tại mỗi ô, còn định lý~\ref{thm:ch13-chan-duoi-lipschitz}
chỉ cấm sai số nhỏ hơn cỡ $L \cdot 2^{-b/d}$. Một đại lượng giảm theo đa thức
của $b$, một đại lượng giảm theo hàm mũ của $b$: khoảng cách giữa chúng không
phải một hằng số. Chỗ hụt nằm ở mệnh đề 3.6 của bài, vốn viết lại chặn trên
thành $\mathcal{O}(L \cdot 2^{-b/d})$ bằng cách cho rằng ngân sách $b$ mua được
$2^{b}$ ô, tức bỏ qua chính khoản tiền mã hóa giá trị mà chứng minh của chặn
trên đã tính. Đây là cùng một kiểu hụt với hệ quả 3.8 ở cuối mục này.

Hệ quả cho chương là cụ thể và đáng nói ra, vì nó thu hẹp điều mục sau được
phép kết luận. Chặn trên nói rằng giải thích một hàm Lipschitz \emph{có thể}
tốn số bit tăng theo hàm mũ của số chiều. Chặn dưới, đọc theo chiều ngân sách,
chỉ nói rằng nó tốn ít nhất cỡ $d \log(L/\delta)$ bit, tức tăng tuyến tính theo
số chiều. Vậy lời nguyền số chiều ở đây là một tính chất của phép dựng lưới và
của mọi phép dựng cùng kiểu, không phải một điều đã được chứng minh là không
tránh được.
...
lý~\ref{thm:ch13-chan-duoi-lipschitz} cộng với dòng đầu của
bảng~\ref{tab:ch13-do-phuc-tap-lop-mo-hinh}, hai kết quả mà bài có chứng minh:
gán cho một mô hình tuyến tính $n$ đặc trưng ngân sách $b$ mà dòng ấy cho, thì
tồn tại những hàm $L$-Lipschitz mà mọi mô hình tuyến tính trong ngân sách ấy đều
mắc sai số ít nhất cỡ $L \cdot 2^{-b/d}$.
