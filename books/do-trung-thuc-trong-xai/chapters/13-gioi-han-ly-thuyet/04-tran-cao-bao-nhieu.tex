...
kính $h/L = 1/(2m)$ quanh tâm, nằm gọn trong ô, nên các giá rời nhau. Với mỗi
vector dấu $s \in \{-1,+1\}^{m^d}$ đặt $f_s = \sum_c s_c \varphi_c$. Mỗi $f_s$
là $L$-Lipschitz, và hai hàm khác dấu ở ô $c$ thì lệch nhau $2h = L/m$ ngay tại
tâm ô ấy, nên
\[
...
Hệ quả cho chương là cụ thể. Ở ngân sách $b$, phép dựng lưới đạt sai số cỡ
$L \cdot b^{-1/d}$ nhân thêm một thừa số lôgarit, vì $b$ bit mua được cỡ $b$ ô
lưới sau khi đã trả tiền mã hóa giá trị tại mỗi ô; phép đếm vừa rồi cấm mọi lời
giải thích xuống dưới cỡ $L \cdot b^{-1/d}$. Hai chặn khớp nhau ở số mũ và chỉ
cách nhau thừa số lôgarit ấy. Đọc theo $\delta$ thì câu gọn hơn: giải thích một
hàm Lipschitz trong sai số $\delta$ tốn ít nhất cỡ $(L/\delta)^d$ bit. Vậy lời
nguyền số chiều ở đây không phải một tính chất riêng của phép dựng lưới, mà là
tính chất của chính bài toán.
...
vốn quá yếu để đỡ được, và mệnh đề 3.6 thì viết chặn trên thành
