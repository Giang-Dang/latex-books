...
Với một kết quả dạng chặn, chỗ cần soi là các định nghĩa chứ không phải phần
chứng minh, nên trước hết phải có đủ bộ định nghĩa. Mục này dựng chúng, và cả
cái trần lẫn mọi giới hạn của nó đều nằm sẵn trong đây.
...
Hai dòng số học cho thấy khoảng cách giữa hai đại lượng có thể lớn tùy ý. Lấy
không gian đầu vào chỉ gồm hai điểm $a$ và $b$, với $f(a) = 0$, $f(b) = 1$, và
lấy $g$ là hàm hằng bằng không. Cho phân phối đặt khối lượng $1-\epsilon$ vào
$a$ và $\epsilon$ vào $b$. Khi ấy
\[
  \mathcal{E}_{\mathcal{D}}(f,g) = (1-\epsilon)\cdot 0 + \epsilon \cdot 1
  = \epsilon,
  \qquad
  \mathcal{E}_{\infty}(f,g) = \max(0,1) = 1 .
\]
Chọn $\epsilon$ nhỏ tùy ý thì sai số kỳ vọng nhỏ tùy ý trong khi sai số xấu nhất
vẫn bằng 1. Vì vậy một chỗ lệch, dù lệch hẳn, không bác được một bảo đảm về sai
số trung bình chừng nào chưa nói khối lượng xác suất tại chỗ lệch ấy là bao
nhiêu. Trường hợp $\epsilon = 0$ đẩy điều đó tới cùng: sai số kỳ vọng bằng không
trong khi hai hàm vẫn khác nhau tại $b$, nên mọi phát biểu về sai số kỳ vọng chỉ
có nghĩa khi $\mathcal{D}$ đã được nói rõ.
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/ch13-mien-kha-thi}
