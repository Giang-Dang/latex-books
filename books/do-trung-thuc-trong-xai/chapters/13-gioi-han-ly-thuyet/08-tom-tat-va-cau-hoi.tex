...
\begin{itemize}
  ...
  nghịch đảo sai số, đó là lời nguyền số chiều đặt vào bài toán giải thích. Chứng
  minh chặn dưới của bài không đứng được, vì nó đếm số hàm trong ngân sách rồi
  dùng con số ấy làm số vùng giá trị của một hàm; sách thay bằng một phép đếm
  trên họ hàm chóp, và phép đếm ấy cho chặn dưới cùng số mũ với chặn trên. Vậy
  lời nguyền số chiều là tính chất của bài toán chứ không riêng của phép dựng
  lưới. Lối ra duy nhất trong bài là số chiều nội tại: nếu dữ liệu nằm
