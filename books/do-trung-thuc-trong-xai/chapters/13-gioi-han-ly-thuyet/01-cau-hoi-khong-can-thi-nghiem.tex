...
Với bài báo này, câu trả lời ấy đọc được ngay từ phép đếm chữ. Rà toàn văn cả 65
trang, kể cả phần tài liệu tham khảo, chữ \enquote{faithfulness} và chữ
\enquote{faithful} không xuất hiện lần nào. Chữ \enquote{ground truth} cũng
không xuất hiện lần nào. Chữ \enquote{attribution} xuất hiện đúng một lần, ở
trang 2, trong một câu liệt kê các họ phương pháp giải thích của phần mở đầu.
Các tên Shapley, deletion, insertion và saliency không xuất hiện lần nào.

Một phép đếm nữa đáng nêu vì bản thân nó dễ đọc nhầm. Chữ \enquote{metric} xuất
hiện mười sáu lần, con số đủ lớn để người đọc tưởng đây là một bài bàn về chỉ
số. Không phải: mỗi lần xuất hiện, chữ ấy hoặc chỉ một trong hai cách đo sai số
mà mục~\ref{sec:ch13-ham-xap-xi} sẽ dựng, hoặc nằm bên
trong \enquote{geometric}, \enquote{isoperimetric} và \enquote{parametric}.
Không một họ chỉ số nào của chương~\ref{ch:do-do-trung-thuc} có mặt trong bài,
dưới bất kỳ tên nào.

Vậy đối tượng của bài là sai số giữa đầu ra của lời giải thích và đầu ra của mô
hình, dưới một hạn mức đặt lên độ dài mô tả của lời giải thích. Đó là đại lượng
mà chương~\ref{ch:lime} gọi là độ khớp của $g$ với $f$ và
mục~\ref{sec:ch10-mot-tu-khong-xuat-hien} tách khỏi độ trung thực. Một cái trần
...
lệch khỏi đối tượng của phần, sau bài báo neo và ba bài của hai chương trước, và
là lần đầu tiên chỗ lệch nằm ở loại phát biểu chứ không ở họ lời giải thích.
