...
\begin{figure}[htbp]
  ...
  ngang qua các vị trí của một bản đồ đặc trưng. Mũi tên mang nhãn
  \enquote{phép lấy giới hạn} là bước lấy tích phân, phần duy nhất không phải
  một phép cộng hữu hạn. Sơ đồ là bản đọc lại của sách về cơ chế mà hai bài báo
  gốc mô tả~\autocite{p11ig,p12gradcam}.}
