...
phục một phần vấn đề về đơn vị đo: đạo hàm riêng có đơn vị là đầu ra trên một
đơn vị của đặc trưng, nên hai đặc trưng đo bằng hai đơn vị khác nhau không so
được với nhau qua đạo hàm, còn tích $x_i\,\partial F(x)/\partial x_i$ thì mang
đơn vị của đầu ra với mọi $i$. Tuy nhiên tích ấy vẫn chỉ đọc độ dốc tại điểm
cuối. Một đơn vị ReLU có
thể đã thay đổi đầu ra trên đường đi tới $x$, rồi bão hòa ở $x$ và cho gradient
bằng không~\autocite{p11ig}. Khi đó, một lời giải thích chỉ nhìn điểm đến sẽ bỏ mất sự thay đổi đã xảy ra
trên đường tới đó.

Đây không phải là lời phản đối việc dùng đạo hàm. Đạo hàm bảo toàn một thuộc
tính quan trọng mà bài báo về Integrated Gradients dựa vào: hai mạng tính cùng
một hàm có cùng gradient gần như mọi nơi~\autocite{p11ig}.
