...
chương đi thu các phát biểu hạn chế cần biết rằng một trong các câu hỏi nó sắp
liệt kê đã có lời đáp ở một phía, và lời đáp ấy không lan sang được.
...
mục~\ref{sec:ch09-dinh-nghia-lai} đã tách chúng ra làm hai tính chất.} Điều kiện này khác bốn
...
\index{chuỗi suy luận!bốn chỗ đứng của bốn bài|)}%
Chương~\ref{ch:khoang-trong-nghien-cuu} khép lại sách bằng cách đọc lại cái sổ
các phát biểu hạn chế mà Phần~IV đã lập và Phần~V ghi thêm vào, và nó nhận từ
chương này một thứ mà không chương nào khác đưa: một chỗ mà phép đo đã được làm.
