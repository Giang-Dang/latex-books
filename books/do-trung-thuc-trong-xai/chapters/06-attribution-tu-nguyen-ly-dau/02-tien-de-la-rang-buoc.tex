...
Tuy vậy, ba điều kiện cùng lúc rất mạnh.

\begin{theorem}
\label{thm:ch06-ba-tien-de}
Với mô hình đủ trơn, mọi attribution thỏa cả ba điều kiện đều có dạng
Gradient$\mathbin{\times}$Input cộng với một phần dư do độ cong của mô hình
chi phối~\autocite{p17firstprinciples}.
\end{theorem}
