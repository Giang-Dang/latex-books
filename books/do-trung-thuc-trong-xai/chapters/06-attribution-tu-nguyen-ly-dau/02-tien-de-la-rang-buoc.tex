...
Phát biểu dưới đây nói tới phần dư Taylor, nên viết khai triển ra trước thì đọc
được ngay. Cho $f$ khả vi liên tục hai lần và cho một điểm khai triển
...
$|R_a(x)| \le \tfrac{1}{2} M \lVert x-a \rVert^2$ với $M$ là chặn trên của độ
cong, tức của chuẩn ma trận đạo hàm bậc hai trên đoạn nối $a$ với $x$.

Hai số hạng ấy chia nhau hai việc, và đó là điều làm cho định lý có nội dung.
Số hạng $\nabla f(a)^{\top}(x-a)$ là một tổng theo từng tọa độ: nó tách sẵn
...
không tách theo tọa độ được, vì nó chứa các số hạng chéo trong đó hai đặc trưng
chỉ có tác dụng khi đi cùng nhau. Định lý nói ba tiên đề ép attribution về đúng
phần tuyến tính ấy, lấy $a$ là baseline, cộng thêm một cách chia nào đó cho
$R_a$.
