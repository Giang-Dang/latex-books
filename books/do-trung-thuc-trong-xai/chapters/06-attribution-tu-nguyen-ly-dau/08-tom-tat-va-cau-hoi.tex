\begin{tomtat}
\begin{itemize}
  \item Tính đầy đủ, độ nhạy và \tn{tính tuyến tính}{linearity} loại một số hành
  vi của attribution, nhưng khi đi cùng nhau chúng bó lớp phương pháp vào dạng
  ...
  hình.
  \item Một attribution trong khung có dạng tích phân của $f$ theo
  \tn{độ đo}{measure} $\mu_{j,x}$. Độ đo ghi lựa chọn về những đầu vào nào được lấy trung bình.
  \item Nhiều phương pháp dựa trên \tn{loại bỏ đặc trưng}{feature removal} và
