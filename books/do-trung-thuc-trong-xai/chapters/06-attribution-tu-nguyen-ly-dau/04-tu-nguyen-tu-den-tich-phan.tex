...
Trước khi sang bước cuối thì nên thấy vì sao $\mu_{j,x}$ không thể là một cách
gán số tùy ý, và một vùng chia hai là đủ để thấy. Lấy $d = 1$, cắt $[0,1]$
thành $R = (0,\tfrac{1}{2}]$ và $R' = (\tfrac{1}{2},1]$, đúng dạng nửa mở mà mục
trước đã đặt cho mọi hình hộp, rồi lấy $f$ là hàm hằng
bằng $c$ trên cả khối. Hàm ấy viết được hai cách:
\[
  f = c\,\mathbf{1}_{(0,1]}
    = c\,\mathbf{1}_{R} + c\,\mathbf{1}_{R'} .
\]
Áp tính tuyến tính vào cách viết thứ nhất cho
$\varphi_j(x,f) = c\,\mu_{j,x}((0,1])$; áp vào cách viết thứ hai cho
$c\,\mu_{j,x}(R) + c\,\mu_{j,x}(R')$. Hai con số ấy phải bằng nhau, vì chúng là
attribution của cùng một hàm. Nên
\[
  \mu_{j,x}((0,1]) = \mu_{j,x}(R) + \mu_{j,x}(R') .
\]
Không ai áp đặt tính cộng ấy từ bên ngoài: nó bị chính tiên đề tuyến tính ép ra,
ngay khi ta cho phép mô tả cùng một hàm bằng hai cách chia vùng khác nhau.

Cái mà bước thứ tư cần thì nhiều hơn thế, và khoảng cách giữa hai bên chính là
nội dung của giả thiết. Phép cắt trên cho tính cộng hữu hạn, trên các hình hộp.
Một độ đo có dấu đòi tính cộng đếm được, trên mọi tập Borel, và tính cộng đếm
được mạnh thực sự chứ không phải hệ quả của tính cộng hữu hạn: có những cách gán
trọng lượng cộng hữu hạn mà không phải độ đo. Phép cắt cũng không sinh ra giá
trị âm nào; dấu âm có mặt vì quy tắc nguyên tử được phép gán số âm, chứ không vì
lập luận vừa rồi. Vì vậy điều phép cắt cho thấy là tính cộng \emph{bắt đầu} từ
đâu, còn phần còn lại là điều bài báo lấy làm giả thiết, như đoạn dưới nói rõ.
