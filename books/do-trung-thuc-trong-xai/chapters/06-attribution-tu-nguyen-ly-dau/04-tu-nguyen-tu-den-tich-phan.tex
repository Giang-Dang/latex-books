...
thành $R = [0,\tfrac{1}{2}]$ và $R' = (\tfrac{1}{2},1]$, rồi lấy $f$ là hàm hằng
...
ngay khi ta cho phép mô tả cùng một hàm bằng hai cách chia vùng khác nhau. Bước
thứ tư đòi đúng tính chất này, chỉ mở rộng từ hai mảnh lên một dãy đếm được
mảnh, và một cách gán trọng lượng thỏa điều đó, có thể nhận giá trị âm, chính là
cái mà giải tích gọi là độ đo có dấu.
