...
$z'$; số phần tử được lấy cũng thay đổi giữa các
...
\begin{figure}[htbp]
  \centering
  \input{figures/tikz/ch03-quy-trinh-lime}
  ...
  trước khi mô hình trả $f(z)$; đó là chỗ một bit vắng mặt phải được dịch
  thành một can thiệp cụ thể, và là giả định mà phần còn lại của quy trình
  không kiểm tra lại~\autocite{p09lime}.}
