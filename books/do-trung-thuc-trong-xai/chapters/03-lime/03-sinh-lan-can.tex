...
$z'$; số phần tử được lấy cũng thay đổi giữa các lần sinh mẫu
~\autocite{p09lime}.
...
không mở mô hình hộp đen; nó chỉ hỏi mô hình đã phản ứng thế nào với đầu vào
đã dựng lại.
...
\begin{figure}[htbp]
  ...
  mô hình thay thế $g$, chứ không truy xuất cơ chế bên trong của $f$
  ~\autocite{p09lime}.}
