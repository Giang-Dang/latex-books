...
Ở đây $\mathcal{Z}$ là tập mẫu mà thuật toán dựng: mỗi phần tử mang biểu diễn
đã nhiễu $z'$, đầu vào $z$ được dựng lại từ nó, đầu ra $f(z)$ và trọng số
$\pi_x(z)$. Phương trình~\ref{eq:ch03-mat-mat-cuc-bo} chỉ đọc hai thành phần
đầu và trọng số. Một mẫu xa vẫn có thể xuất hiện trong phép khớp, nhưng trọng
...
\begin{algorithm}[htbp]
  \caption{Pseudo-code cho lời giải thích LIME thưa, dựng theo mục 3.3, mục
  3.4 và thuật toán 1 của Ribeiro, Singh và Guestrin~\autocite{p09lime}}
  \label{alg:ch03-lime}
  \begin{algorithmic}[1]
