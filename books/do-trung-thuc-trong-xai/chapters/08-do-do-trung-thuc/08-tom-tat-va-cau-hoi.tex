...
\begin{itemize}
  ...
  \item Hình~\ref{fig:ch08-vong-lap-do} rút hai họ chỉ số dựa trên xếp hạng, họ
  xóa dần và họ huấn luyện lại, về một vòng lặp với ba
  lựa chọn tự do: chọn tập con nào theo thứ tự điểm, thay các đặc trưng bị bỏ
  bằng giá trị gì, và so đại lượng nào. Hai họ ấy khác nhau đúng ở ba chỗ ấy.
  Họ tiên đề và phép thử điều kiện cần không cần một thứ tự nên không đi qua
  vòng lặp này; bảng~\ref{tab:ch08-bon-ho} đặt cả bốn cạnh nhau.
  ...
  chẩn đoán rằng nhóm dựa trên \tn{mức quan trọng}{importance} đồng nhất mức
  quan trọng với độ
...
\cauhoi
\begin{cauhoids}
  \item Với hai họ chỉ số dựa trên xếp hạng, hãy điền ba ô viền đứt của
  hình~\ref{fig:ch08-vong-lap-do}: tập con được chọn thế nào, giá trị thay thế
  là gì, và đại lượng nào được so. Hai họ ấy trùng nhau ở ô nào và khác nhau ở ô
  nào? Sau đó cho biết hai họ còn lại vướng ở ô nào nếu ta cố ép chúng vào cùng
  sơ đồ.
