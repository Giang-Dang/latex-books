...
Bốn nhóm ở các mục trên được xếp theo bốn câu hỏi của
bảng~\ref{tab:ch08-bon-ho}, tức theo cách sách này đọc chúng; hai nhóm đầu còn
xếp được theo ba ô của hình~\ref{fig:ch08-vong-lap-do}, hai nhóm sau thì không. Bài báo neo
...
cái gì}: nhóm dựa trên \tn{mức quan trọng}{importance}, nhóm dựa trên tham số, nhóm dựa trên
...
nó hỏi lời kể lại các \tn{bước suy luận}{CoT step} có phản ánh đúng phép tính
đã dẫn tới câu trả lời hay không. Không tên chỉ số nào của họ xóa dần và họ tiên đề xuất hiện trong bài báo đó, và
...
chương~\ref{ch:shap} làm dụng cụ đo: nó tính đóng góp SHAP của các token đầu
vào hai lần, một lần cho việc sinh câu trả lời và một lần cho việc sinh chuỗi
suy luận, rồi lấy mức giống nhau giữa hai bản đóng góp làm điểm trung thực.
Nhóm thứ tư thì đo thứ khác hẳn: lời giải
...
nó nói đúng cái mà chương này đi tìm: giả định nào đã đi vào dụng cụ đo mà
không được khai báo. Với nhóm dựa trên
